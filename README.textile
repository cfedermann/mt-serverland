...
More details to be added soon, in case of problems, drop me an email at @cfedermann@dfki.de@.
...
Before you can actually use a worker server inside the MT Server Land application, you have to create a corresponding @WorkerServer@ instance inside the django admin backend at @http://127.0.0.1:8000/admin/dashboard/workerserver/@.
